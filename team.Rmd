...
# The graph above is a histogram distrubution of Glycosolated Hemoglobin Count. Made using ggplot2. 
```
...
# The graph above is a histogram distrubution of the log of the Glycosolated Hemoglobin Count. Made using ggplot2. Used log to better remove the skew of the histogram. 
```
...
diabetes_clean %>% 
  ...
  ggplot(aes(x=location, y=mean.glyhb_star, fill=frame)) + geom_bar(stat="identity", position = "dodge") + xlab("Location") + ylab("Mean of Glyhb Star") + labs(title = "Location vs. Mean of Glyhb Star by Frame")

# Histogram of the Mean of Glyhb_star separated by the frame.
```
...
# Graph of the log of Glycosolated Hemoglobin by ratio, separated by gender. 
```
...
# Graph of the log of Glycosolated Hemoglobin by Age, separated by gender. 
```
...
# Graph of the log of Glycosolated Hemoglobin by Blood Pressure, separated by gender. 
```
...
# Graph of the log of Glycosolated Hemoglobin by Weight, separated by gender. 
```
...
# Graph of the log of Glycosolated Hemoglobin by Hip Size, separated by gender. 
```
...
# Graph of the Waist Sizes vs. Hip Size, separated by Frame. 
```
...
# Graph of Waist Size vs. Hip Size by frame.
```
