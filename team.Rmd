...
```{r}
ggplot(diabetes_clean, aes(x=glyhb_star, y=ratio)) + geom_jitter() + geom_smooth(method = "lm", se = FALSE) + labs(title="Glycosolated Hemoglobin by Ratio", x="Glycosolated Hemoglobin", y="Ratio (Cholesterol/HDL)")

ggplot(diabetes_clean, aes(x=glyhb_star, y=age)) + geom_point() + geom_smooth(method = "lm", se = FALSE) + labs(title="Glycosolated Hemoglobin by Ratio", x="Glycosolated Hemoglobin", y="Ratio (Cholesterol/HDL)")
  

```
ratio, bp.1s, age, gender, hip and weight.
